/****************************************************************************
** Meta object code from reading C++ file 'MessageBoxEx.h'
**
...
#error "The header file 'MessageBoxEx.h' doesn't include <QObject>."
...
void MessageBoxEx::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MessageBoxEx::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageBoxEx::btnOkClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MessageBoxEx::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageBoxEx::btnCancelClicked)) {
                *result = 1;
                return;
            }
        }
